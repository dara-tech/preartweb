      ...
      <div className="bg-card border-b border-border">
        <div className="px-4 sm:px-6 py-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-sm font-medium text-muted-foreground">Child Visits</h1>
          ...
          <Card className="">
            <CardContent className="p-12 text-center">
              ...
              <p className="text-sm text-muted-foreground mb-6">
                {searchTerm ? 'Try adjusting your search or filters' : 'No child visits recorded yet'}
              </p>
                  ...
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <div className="flex items-center gap-2">
                      <Button
                        variant="outline"
                        size="sm"
                        onClick={() => navigate(`/visits/child/${visit.clinicId || visit.patientId}/${visit.visitId || visit.id}`)}
