          ...
          <Card className="">
            <CardContent className="p-12 text-center">
              ...
              <p className="text-sm text-muted-foreground mb-6">
                {searchTerm ? 'Try adjusting your search or filters' : 'No infant visits recorded yet'}
              </p>
                  ...
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <div className="flex items-center gap-2">
                      <Button
                        variant="outline"
                        size="sm"
                        onClick={() => navigate(`/visits/infant/${visit.clinicId || visit.patientId}/${visit.visitId || visit.id}`)}
