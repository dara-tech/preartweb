...
function Card({
  ...
  return (
    <div
      data-slot="card"
      className={cn(
        "bg-card text-card-foreground flex flex-col gap-2 rounded-none border border-border py-3",
        className
      )}
      {...props} />
  );
...
function CardContent({
  ...
  return (<div data-slot="card-content" className={cn("px-3 py-1", className)} {...props} />);
}
