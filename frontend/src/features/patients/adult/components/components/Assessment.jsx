...
function Assessment({ formData, handleInputChange, showKhmer = false }) {
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <Label htmlFor="cd4" className="text-sm text-gray-700">
          ...
          <div>
            <Label htmlFor="hivViral" className="text-sm text-gray-700">
