-- =====================================================
-- INFANT DNA PCR CONFIRMATORY AT OI DETAILS
-- =====================================================
...
-- =====================================================
-- MAIN QUERY
-- DNA PCR Confirmatory Test for OI (DNAPcr = 4, Con_At = 3, Con_OI = 'True')
-- Matches logic from Rinfants.vb line 455-460: c.DNAPcr = 4 and c.Con_At=3 and c.Con_OI='True'
-- =====================================================
SELECT DISTINCT
  ...
  4 AS dna_test_type,
  'Confirmatory at OI' AS dna_test_display,
  c.OI AS other_dna,
  c.Con_At AS Con_At,
  c.Con_OI AS Con_OI,
  c.Result AS result,
...
FROM (
    -- Part 1: Tests from tbletest where DNAPcr = 4 and Con_At = 3 and Con_OI = 'True'
    SELECT DISTINCT
        n.ClinicID,
        ei.Sex,
        ei.DaBirth,
    ...
    -- Part 2: Visits from tblevmain where DNA = 4 and Con_At = 3 and Con_OI = 'True' (waiting)
    SELECT DISTINCT
        req.ClinicID,
        ei.Sex,
        ei.DaBirth,
...
WHERE c.Con_At IS NOT NULL AND c.Con_At = 3 AND c.Con_OI IS NOT NULL AND c.Con_OI = 'True'
