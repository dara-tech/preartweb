-- =====================================================
-- INDICATOR 6: DNA PCR REQUESTED BY CLINICIAN - CONFIRMATORY
-- =====================================================
-- Lists visits (requests) where DNA = 4 in date range.
-- Matches Rinfants.vb CmdAllpcr: COUNT(DISTINCT If(c.DNA = 4, c.ClinicID, null))
...
SELECT 
    ...
    4 AS dna_test_type,
    'Confirmatory' AS dna_test_display,
