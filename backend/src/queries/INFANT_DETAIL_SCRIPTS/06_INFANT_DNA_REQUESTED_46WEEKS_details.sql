-- =====================================================
-- INDICATOR 6: DNA PCR REQUESTED BY CLINICIAN - 4-6 WEEKS
-- =====================================================
-- Lists visits (requests) where DNA = 1 in date range.
-- Matches Rinfants.vb CmdAllpcr: COUNT(DISTINCT If(c.DNA = 1, c.ClinicID, null))
