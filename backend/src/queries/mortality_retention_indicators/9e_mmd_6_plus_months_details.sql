-- ===================================================================
-- Indicator 9e detail: Percentage of ART patients with MMD ≥6 months
-- Returns patient-level records for patients with MMD ≥6 months
-- ===================================================================
...
active_patients AS (
    ...
    WHERE art.DaArt IS NOT NULL
        ...
        AND DATEDIFF(v.DaApp, v.DatVisit) >= 161
)
