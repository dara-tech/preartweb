-- ===================================================================
-- Indicator 6b detail: Percentage of patients newly initiating ART within 1-7 days of diagnosed date
-- Returns patient-level records for patients who started ART 1-7 days after diagnosis
-- ===================================================================
