...
SELECT
    ...
    CAST(IFNULL(COUNT(DISTINCT pl.ClinicID), 0) AS UNSIGNED) AS Same_Day_Initiation,
    ...
    -- Individual demographic totals for denominator (total newly initiated, not just same-day)
