-- ===================================================================
-- Indicator 9b detail: Percentage of ART patients with MMD 3 months
-- Returns patient-level records for patients with MMD 3 months
-- ===================================================================
...
active_patients AS (
    ...
    WHERE art.DaArt IS NOT NULL
        ...
        AND DATEDIFF(v.DaApp, v.DatVisit) BETWEEN 81 AND 100
)
