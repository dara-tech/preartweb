-- ===================================================================
-- Indicator 12d detail: Percentage of ART patients who have suppressed viral load [WHO VLS.3]
...
ORDER BY Status DESC, VLdostatus DESC, vlresultstatus DESC, last_vl_date DESC, clinicid;
