...
mmd_stats AS (
    SELECT
        ...
        SUM(CASE WHEN ndays BETWEEN 131 AND 160 THEN 1 ELSE 0 END) AS Five_Months,
        ...
        SUM(CASE WHEN type = 'Child' AND Sex = 'Male' AND ndays BETWEEN 131 AND 160 THEN 1 ELSE 0 END) AS Male_0_14_5M,
        SUM(CASE WHEN type = 'Child' AND Sex = 'Female' AND ndays BETWEEN 131 AND 160 THEN 1 ELSE 0 END) AS Female_0_14_5M,
        SUM(CASE WHEN type = 'Adult' AND Sex = 'Male' AND ndays BETWEEN 131 AND 160 THEN 1 ELSE 0 END) AS Male_over_14_5M,
        SUM(CASE WHEN type = 'Adult' AND Sex = 'Female' AND ndays BETWEEN 131 AND 160 THEN 1 ELSE 0 END) AS Female_over_14_5M
