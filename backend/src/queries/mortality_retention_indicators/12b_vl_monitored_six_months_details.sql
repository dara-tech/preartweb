-- ===================================================================
-- Indicator 12b detail: Percentage of ART patients who had VL monitored at six months [WHO VLS.6]
-- Returns patient-level records for patients who had VL monitored in past 12 months
-- ===================================================================
...
ORDER BY Status DESC, VLdostatus DESC, last_vl_date DESC, clinicid;
