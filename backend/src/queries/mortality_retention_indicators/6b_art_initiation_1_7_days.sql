...
SELECT
    ...
    CAST(IFNULL(COUNT(DISTINCT pl.ClinicID), 0) AS UNSIGNED) AS Initiation_1_7_Days,
    ...
    -- Individual demographic totals for denominator (total newly initiated, not just 1-7 days)
