-- ===================================================================
-- Indicator 8a detail: Percentage of patients with CD4 < 350 receiving Cotrimoxazole prophylaxis
-- Returns patient-level records for patients with CD4 < 350 and their prophylaxis status
-- ===================================================================
...
SELECT
    ...
    ctx.LatestCD4 AS latest_cd4,
    ctx.CD4TestDate AS cd4_test_date,
    ctx.ReceivingCotrimoxazole AS receiving_cotrimoxazole
FROM tblcotrimoxazole ctx
JOIN tblaimain main ON main.ClinicID = ctx.ClinicID
LEFT JOIN tblaart art ON main.ClinicID = art.ClinicID
WHERE ctx.type = 'Adult'
...
SELECT
    ...
    ctx.ReceivingCotrimoxazole AS receiving_cotrimoxazole
FROM tblcotrimoxazole ctx
JOIN tblcimain main ON main.ClinicID = ctx.ClinicID
LEFT JOIN tblcart art ON main.ClinicID = art.ClinicID
WHERE ctx.type = 'Child'
