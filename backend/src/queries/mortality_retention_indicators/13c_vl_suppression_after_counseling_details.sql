-- ===================================================================
-- Indicator 13c detail: Percentage of PLHIV with VL ≥1000 copies/mL who achieved viral suppression after enhanced adherence counselling
-- Returns patient-level records for patients who received EAC and achieved suppression in follow-up VL
-- ===================================================================
...
SELECT
    ...
    CASE 
        WHEN f.FollowupValue IS NOT NULL AND f.FollowupValue < 1000 THEN 'Suppressed'
        WHEN f.FollowupValue IS NOT NULL AND f.FollowupValue >= 1000 THEN 'Not Suppressed'
        ELSE 'No Followup'
...
WHERE f.typepatients = '15+'
  ...
  AND f.FollowupValue IS NOT NULL
  AND f.FollowupValue < 1000
