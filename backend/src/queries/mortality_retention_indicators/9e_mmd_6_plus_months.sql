...
mmd_stats AS (
    SELECT
        ...
        SUM(CASE WHEN ndays >= 161 THEN 1 ELSE 0 END) AS Six_Plus_Months,
        ...
        SUM(CASE WHEN type = 'Child' AND Sex = 'Male' AND ndays >= 161 THEN 1 ELSE 0 END) AS Male_0_14_6M_Plus,
        SUM(CASE WHEN type = 'Child' AND Sex = 'Female' AND ndays >= 161 THEN 1 ELSE 0 END) AS Female_0_14_6M_Plus,
        SUM(CASE WHEN type = 'Adult' AND Sex = 'Male' AND ndays >= 161 THEN 1 ELSE 0 END) AS Male_over_14_6M_Plus,
        SUM(CASE WHEN type = 'Adult' AND Sex = 'Female' AND ndays >= 161 THEN 1 ELSE 0 END) AS Female_over_14_6M_Plus
