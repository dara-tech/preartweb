...
-- Late Beyond Buffer: >5 days late from previous visit's appointment
-- Matches CQI script logic: DATEDIFF(current_visit_date, previous_visit_appointment) > 5
-- ===================================================================
...
late_beyond_buffer AS (
    ...
    -- DATEDIFF(current_visit_date, previous_visit_appointment) > 5
    SELECT
        type,
        Sex,
        ClinicID,
