-- ===================================================================
-- Indicator 5b detail: Percentage of late visits within ARV supply buffer date
-- Returns patient-level records for visits that are 1-5 days late from previous visit's appointment
-- ===================================================================
...
SELECT
    ...
    'Late Within Buffer (1-5 days)' AS visit_status
FROM late_within_buffer l
