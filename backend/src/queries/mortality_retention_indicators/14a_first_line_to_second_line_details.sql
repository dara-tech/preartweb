-- ===================================================================
-- Indicator 14a detail: Percentage of PLHIV receiving first line ART with two consecutive VL ≥1000 copies/mL switching to second line
...
FROM tblfirst_to_second_line s
