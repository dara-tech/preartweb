-- ===================================================================
-- Indicator 11b detail: Percentage of ART patients completed TPT (TPT Complete)
-- Returns patient-level records for patients who completed TPT
-- ===================================================================
...
SELECT
    ...
    ta.Tptdrugname AS tpt_drug_name,
    ta.dateStart AS tpt_start_date,
    ta.Datestop AS tpt_stop_date,
    ta.duration AS tpt_duration_months,
    ta.tptstatus AS tpt_status
FROM tblactive ta
...
ORDER BY tpt_status DESC, tpt_start_date DESC, clinicid;
