...
mmd_stats AS (
    SELECT
        ...
        SUM(CASE WHEN ndays <= 80 THEN 1 ELSE 0 END) AS Less_Than_3M,
        ...
        SUM(CASE WHEN type = 'Child' AND Sex = 'Male' AND ndays <= 80 THEN 1 ELSE 0 END) AS Male_0_14_Less_3M,
        SUM(CASE WHEN type = 'Child' AND Sex = 'Female' AND ndays <= 80 THEN 1 ELSE 0 END) AS Female_0_14_Less_3M,
        SUM(CASE WHEN type = 'Adult' AND Sex = 'Male' AND ndays <= 80 THEN 1 ELSE 0 END) AS Male_over_14_Less_3M,
        SUM(CASE WHEN type = 'Adult' AND Sex = 'Female' AND ndays <= 80 THEN 1 ELSE 0 END) AS Female_over_14_Less_3M
