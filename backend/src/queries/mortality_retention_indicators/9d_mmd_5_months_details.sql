-- ===================================================================
-- Indicator 9d detail: Percentage of ART patients with MMD 5 months
-- Returns patient-level records for patients with MMD 5 months
-- ===================================================================
...
active_patients AS (
    ...
    WHERE art.DaArt IS NOT NULL
        ...
        AND DATEDIFF(v.DaApp, v.DatVisit) BETWEEN 131 AND 160
)
