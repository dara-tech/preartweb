-- ===================================================================
-- Indicator 6a detail: Percentage of patients newly initiating ART on same-day (0 day) as diagnosed date
-- Returns patient-level records for patients who started ART on the same day as diagnosis
-- ===================================================================
...
SELECT
    ...
    'Same Day (0 days)' AS initiation_status
FROM tblaimain main
