-- =====================================================
-- PNTT_NEW_PART_HTS_POS_DETAILS - New Patient - Partner Tested Positive by HTS DETAIL
-- =====================================================
-- Disaggregated records for: Partner who were tested HIV positive by HTS
-- Logic matches `PNTT_NEW_PART_HTS_POS_aggregate.sql`
-- =====================================================
...
SELECT
    'PNTT_NEW_PART_HTS_POS' AS indicator_code,
