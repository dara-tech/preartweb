-- =====================================================
-- PNTT_NEW_PART_HIVST_DETAILS - New Patient - Partner Tested by HIVST DETAIL
-- =====================================================
-- Disaggregated records for: Partner who were tested for HIV by HIVST
-- Logic matches `PNTT_NEW_PART_HIVST_aggregate.sql`
-- =====================================================
...
SELECT
    'PNTT_NEW_PART_HIVST' AS indicator_code,
