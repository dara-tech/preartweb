-- =====================================================
-- PNTT_OLD_PART_PROV_DETAILS - Old Patient - Partner Provider DETAIL
-- =====================================================
-- Disaggregated records for: Old partner provider + Test HIV + Positive
-- Logic matches `PNTT_OLD_PART_PROV_aggregate.sql`
-- =====================================================
...
SELECT
    'PNTT_OLD_PART_PROV' AS indicator_code,
