-- =====================================================
-- PNTT_NEW_CHILD_TEST_DETAILS - New Patient - Child Tested DETAIL
-- =====================================================
-- Disaggregated records for: Children who were tested for HIV
-- Logic matches `PNTT_NEW_CHILD_TEST_aggregate.sql`
-- =====================================================
...
SELECT DISTINCT
    'PNTT_NEW_CHILD_TEST' AS indicator_code,
