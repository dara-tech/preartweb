-- =====================================================
-- PNTT_NEW_CHILD_REG_DETAILS - New Patient - Children Registered DETAIL
-- =====================================================
-- Disaggregated records for: Number of children registered
-- Logic matches `PNTT_NEW_CHILD_REG_aggregate.sql`
-- =====================================================
...
SELECT DISTINCT
    'PNTT_NEW_CHILD_REG' AS indicator_code,
