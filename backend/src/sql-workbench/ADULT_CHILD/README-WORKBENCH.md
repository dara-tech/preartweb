...
- `05.3_art_pregnant.sql` - 05.3 ART PREGNANT
- `05.3_art_pregnant_details.sql` - 05.3 ART PREGNANT DETAILS
...
- `08.2_dead.sql` - 08.2 DEAD
- `08.2_dead_details.sql` - 08.2 DEAD DETAILS
- `08.3_lost_to_followup.sql` - 08.3 LOST TO FOLLOWUP
- `08.3_lost_to_followup_details.sql` - 08.3 LOST TO FOLLOWUP DETAILS
- `08.4_transfer_out.sql` - 08.4 TRANSFER OUT
- `08.4_transfer_out_details.sql` - 08.4 TRANSFER OUT DETAILS
- `08_tpt_new_start.sql` - 08 TPT NEW START
- `08_tpt_new_start_details.sql` - 08 TPT NEW START DETAILS
