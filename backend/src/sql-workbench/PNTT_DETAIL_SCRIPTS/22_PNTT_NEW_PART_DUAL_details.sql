-- =====================================================
-- PNTT_NEW_PART_DUAL_DETAILS - New Patient - Partner Dual DETAIL
-- =====================================================
-- Disaggregated records for: Partner dual + Test HIV + Positive
-- Logic matches `PNTT_NEW_PART_DUAL_aggregate.sql`
-- =====================================================

SET @StartDate = '2025-04-01';
SET @EndDate   = '2025-06-30';

-- Aggregate WHERE adds: tblapnttpart.NotificationIPV = 4

SELECT
    'PNTT_NEW_PART_DUAL' AS indicator_code,
