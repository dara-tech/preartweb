-- =====================================================
-- PNTT_NEW_CHILD_PROV_DETAILS - New Patient - Child Provider DETAIL
-- =====================================================
-- Disaggregated records for: Number of Child Provider +Test + Pos
-- Logic matches `PNTT_NEW_CHILD_PROV_aggregate.sql`
-- =====================================================
...
SELECT DISTINCT
    'PNTT_NEW_CHILD_PROV' AS indicator_code,
