-- =====================================================
-- PNTT_NEW_CHILD_CONT_DETAILS - New Patient - Child Contact DETAIL
-- =====================================================
-- Disaggregated records for: Number of child contact + Test + Positive
-- Logic matches `PNTT_NEW_CHILD_CONT_aggregate.sql`
-- =====================================================

SET @StartDate = '2025-04-01';
SET @EndDate   = '2025-06-30';

-- Aggregate WHERE adds: tblapnttchild.PlanChild = 2

SELECT DISTINCT
    'PNTT_NEW_CHILD_CONT' AS indicator_code,
